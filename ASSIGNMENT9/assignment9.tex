...
\begin{align}
\frac{1}{2}m_1^2\vec{v}^2_{1i}&=\frac{1}{2}m_1^2\vec{v}^2_{1f}+\frac{1}{2}m_2^2\vec{v}^2_{2f}\\
\implies\vec{v}^2_{1i}&=\vec{v}^2_{1f}+\vec{v}^2_{2f}\quad(\because m_1=m_2)\label{2.0.2}
\end{align}
...
\implies\vec{v}^2_{1i}&=\vec{v}^2_{1f}+\vec{v}^2_{2f}+2\vec{v}_{1f}.\vec{v}_{2f}\cos{(\theta_1+\theta_2)}\label{2.0.4}
\end{align}
